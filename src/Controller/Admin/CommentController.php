...
class CommentController extends AbstractController
{
    ...
    {
        //$comments=$commentRepository->findAll();   //findAll komutu entity den getiriyor.
        $comments=$commentRepository->getAllComments();   //repository den entity i kullanarak getir.
        //dump($comments);
        //die();
